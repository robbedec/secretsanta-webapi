        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Present_Wishlists_WishlistId",
            ...
            migrationBuilder.InsertData(
                table: "Wishlists",
                columns: new[] { "Id", "Created", "OwnerName" },
                values: new object[] { 1, new DateTime(2019, 5, 17, 16, 30, 49, 418, DateTimeKind.Local).AddTicks(8444), "Robbe" });

            migrationBuilder.InsertData(
                table: "Present",
                columns: new[] { "Id", "Category", "Name", "Price", "WishlistId" },
                values: new object[,]
                {
                    { 1, 0, "laptop", 2000.0, 1 },
                    { 2, 0, "fiets", 125.0, 1 },
